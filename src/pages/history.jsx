  ...
  return (
    <div className='w-full'>
      <ul className="menu mx-auto max-w-2xl rounded-lg">
        <li><label htmlFor="my-modal-pending" className='btn btn-warning'>Not Paid | 28 May 2023</label></li>
        <li><label htmlFor="my-modal-history" className='btn btn-error'>Cancelled | 22 May 2022</label></li>
        <li><label htmlFor="my-modal-history" className='btn btn-success'>Paid | 11 Januari 2021</label></li>
        <li><label htmlFor="my-modal-history" className='btn btn-success'>Paid | 10 Januari 2021</label></li>
      </ul>
